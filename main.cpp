...
int main(int argc, char *argv[])
{
  ...
  if (!(argc == 11 && sscanf(argv[1], "%lf", &a) == 1 && sscanf(argv[2], "%lf", &b) == 1 && b >= a && sscanf(argv[3], "%lf", &c) == 1 && sscanf(argv[4], "%lf", &d) == 1 && d >= c
        && sscanf(argv[5], "%lu", &nx) == 1 && nx > 0 && sscanf(argv[6], "%lu", &ny) == 1 && ny > 0 &&sscanf(argv[7], "%d", &k) == 1 && k >= 0 && k <= 7
        && sscanf(argv[8], "%lf", &eps) == 1 && eps > 0 && sscanf(argv[9], "%d", &max_it) == 1 && max_it >= 1 && sscanf(argv[10], "%d", &p) == 1 && p >= 1))
  {
